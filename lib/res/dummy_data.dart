class DummyData {
  static const friends = [
    {
      'firstName' : 'Lady',
      'lastName' : 'CloudHunter',
      'username' : 'lilmisstoothfairy',
      'avatar' : 'yoga',
    },
    {
      'firstName' : 'Magical',
    ...
    {
      'firstName' : 'Sweet',
      'lastName' : 'RainbowAngel',
      'username' : 'soggymaplebread',
      'avatar' : 'mario',
    },
    {
      'firstName' : 'Genevieve',
      'lastName' : 'Anderson',
      'username' : 'tooAmeerToBeYourFriend',
      'avatar' : 'drink',
    },
    {
      'firstName' : 'Judy',
      'lastName' : 'Clayton',
      'username' : 'youluckytohaveme',
      'avatar' : 'gift',
    },
    {
      'firstName' : 'blah',
  ...
  static const usersOweYouList = [
    {
      'username': 'thebluffmaster',
      'last_trans': '22-03-2020',
      'amount': 210,
      'avatar': 'blaster',
    },
    {
      'username': 'iamthereforyoubro',
      'last_trans': '21-03-2020',
      'amount': 290,
      'avatar': 'mario',
    },
    {
      'username': 'illbetrayyou',
      'last_trans': '20-03-2020',
      'amount': 190,
      'avatar': 'ghost',
    },
    {
      'username': 'thetwominutedude',
      'last_trans': '10-03-2020',
      'amount': 28,
      'avatar': '',
    },
    {
      'username': 'yourwingman',
  ...
  static final splitsList = [
    {
      ...
      'friends': ['icancelledlastminute', 'twominutesdude', 'Jayesh', 'Mickey'],
    ...
    },
    {
      ...
      'friends': ['nobeerforme', 'gaanemaibajauga', 'Ayush', 'Tarun'],
      'date': DateTime(2021, 12, 31),
      'avatar': 'living-room',
    },
    {
      'tag': '202',
      'outing-name': 'Chachi k taya ki beti ka bday',
      'friends': ['paisesplitkrnehote?', 'nahijauga', 'bu', 'blah'],
